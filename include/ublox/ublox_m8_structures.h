...
PACK(
    struct CfgLogfilter{
        ...
        uint32_t positionThres hold;        //If the 3D position difference is greater than the threshold then the position is logged (0 = not set). minInterval also applies 
        uint8_t checksum[2];
});
...
{
protected:
    uint16_t ACK_ACK = 0x0501;
    uint16_t ACK_NAK = 0x0500;
    uint16_t AID_AOP = 0x0B33;
    uint16_t AID_REQ = 2816;                 // (ID 0x0B 0x00) Receiver Requests Aiding data if not present at startup
    uint16_t AID_EPH = 2865;                 // (ID 0x0B 0x31) Ephemerides
    uint16_t AID_ALM = 2864;                 // (ID 0x0B 0x30) Almanac
    uint16_t AID_HUI = 2818;                 // (ID 0x0B 0x02) GPS Health, Ionospheric, UTC
    uint16_t AID_INI = 2817;                 // (ID 0x0B 0x01) Position, Time, Frequency, Clock Drift
    uint16_t CFG_PRT = 1536;                 // (ID 0x06 0x00) I/O Protocol Settings
    uint16_t CFG_NAV5 = 1572;                // (ID 0x06 0x24) Navigation Algorithm Parameter Settings
    uint16_t CFG_ANT = 0x0613;
    uint16_t CFG_CFG = 0x0609;
    uint16_t CFG_DOSC = 0x0661;
    uint16_t CFG_ESRC = 0x0660;
    uint16_t CFG_GNSS = 0x063E;
    uint16_t CFG_INF = 0x0602;
    uint16_t CFG_LOGFILTER = 0x0647;
    uint16_t CFG_MSG = 0x0601;
    uint16_t CFG_NAVX5 = 0x0623;
    uint16_t CFG_NMEA = 0x0617;
    uint16_t CFG_ODO = 0x061E;
    uint16_t CFG_PM2 = 0x063B;
    uint16_t CFG_RATE = 0x0608;
    uint16_t CFG_RINV = 0x0634;
    uint16_t CFG_RXM = 0x0611;
    uint16_t CFG_SBAS = 0x0616;
    uint16_t CFG_SMGR = 0x0662;
    uint16_t CFG_TMODE2 = 0x063D;
    uint16_t CFG_TP5 = 0x0631;
    uint16_t CFG_USB = 0x061B;
    uint16_t INF_DEBUG = 0x0404;
    uint16_t INF_ERROR = 0x0400;
    uint16_t INF_NOTICE = 0x0402;
    uint16_t INF_TEST = 0x0403;
    uint16_t INF_WARNING = 0x0401;
    uint16_t LOG_FINDTIME = 0x210E;
    uint16_t LOG_INFO = 0x2108;
    uint16_t LOG_RETRIEVEPOSEXTRA = 0x210f;
    uint16_t LOG_RETRIEVEPOS = 0x210b;
    uint16_t LOG_RETRIEVESTRING = 0x210d;
    uint16_t LOG_RETRIEVE = 0x2109;
    uint16_t MGA_ACK = 0x1360;
    uint16_t MGA_DBD = 0x1380;
    uint16_t MGA_FLASH = 0x1321;
    uint16_t MON_GNSS = 0x0A28;
    uint16_t MON_HW2 = 0x0A0B;
    uint16_t MON_HW = 0x0A09;
    uint16_t MON_IO = 0x0A02;
    uint16_t MON_MSGPP = 0x0A06;
    uint16_t MON_PATCH = 0x0A27;
    uint16_t MON_RXBUF = 0x0A07;
    uint16_t MON_RXR = 0x0A21;
    uint16_t MON_SMGR = 0x0A2E;
    uint16_t MON_TXBUF = 0x0A08;
    uint16_t MON_VER = 0x0A04;
    uint16_t NAV_AOPSTATUS = 0x0160;
    uint16_t NAV_ODO = 0x0109;
    uint16_t NAV_ORB = 0x0134;
    uint16_t NAV_POSECEF = 0x0101;
    uint16_t NAV_PVT = 0x0107;
    uint16_t NAV_SAT = 0x0135;
    uint16_t NAV_SBAS = 0x0132;
    uint16_t NAV_TIMEBDS = 0x0124;
    uint16_t NAV_TIMEGLO = 0x0123;
    uint16_t NAV_TIMEUTC = 0x0121;
    uint16_t NAV_VELECEF = 0x0111;
    uint16_t NAV_STATUS = 259;               // (ID 0x01 0x03) TTFF, GPS Fix type, time since startup/reset
    uint16_t NAV_SOL = 262;                  // (ID 0x01 0x06) ECEF Pos,Vel, TOW, Accuracy,
    uint16_t NAV_VELNED = 274;               // (ID 0x01 0x12) Vel (North, East, Down), Speed, Ground Speed
    uint16_t NAV_POSLLH = 258;               // (ID 0x01 0x02) Pos (Lat,Long,Height)
    uint16_t NAV_SVINFO = 304;               // (ID 0x01 0x30) Info on Channels and the SVs they're tracking
    uint16_t NAV_TIMEGPS = 288;              // (ID 0x01 0x20) GPS Time
    uint16_t NAV_DGPS = 305;                 // (ID 0x01 0x31) Outputs correction data used for the nav solution
    uint16_t NAV_DOP = 260;                  // (ID 0x01 0x04) Various Dilution of Precisions
    uint16_t NAV_UTCTIME = 289;              // (ID 0x01 0x21) UTC Time
    uint16_t NAV_CLOCK = 290;                  // (ID 0x01 0x22) Clock information
    uint16_t RXM_RAWX = 0x0215;
    uint16_t RXM_SFRBX = 0x0213;
    uint16_t RXM_SVSI = 544;                 // (ID 0x02 0x20) SV Status Info
    uint16_t TIM_DOSC = 0x0D11;
    uint16_t TIM_FCHG = 0x0D16;
    uint16_t TIM_SMEAS = 0x0D13;
    uint16_t TIM_SVIN = 0x0D04;
    uint16_t TIM_TM2 = 0x0D03;
    uint16_t TIM_TOS = 0x0D12;
    uint16_t TIM_TP = 0x0D01;
    uint16_t TIM_VCOCAL = 0x0D15;
    uint16_t TIM_VRFY = 0x0D06;
};
